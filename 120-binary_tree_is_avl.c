...
/**
 * binary_tree_is_avl - To insert a new node in a Binary Search Tree
 * @tree: an arrya to use
 *
...
/**
 * binary_tree_is_bst - To find the lowest common ancestor of two nodes
...
/**
 * check_less_greater - To verify if node is (less or greater) than root value
 * @tree: Pointer to the first node
 * @n: A root value
 * @flag: To switch to active lees or greater mode
