...
/**
 * is_full_node - To check if a node is full.
 * @node: A pointer to the node that is being checked.
...
/**
 * pop - To remove the top number in the queue.
 ...
 * @head: A pointer to a pointer to the first node in the queue.
 * @child: The node to add to the queue.
 */
...
/**
 * is_complete - To check if the binary tree is complete looking at each level
...
/**
 * binary_tree_is_complete - To check if the binary tree is complete.
 * @tree: The pointer to a pointer to the first node in the tree.
 *
 * Return: 1 if the tree is complete. Otherwise 0.
 */
